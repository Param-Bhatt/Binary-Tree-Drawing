...
to plot them in all 8 part symmetry corresponding its center.
*/
void circle::draw()
{
...
/*Takes the input of Coordinates (x, y) and the center (cx, cy) and the color of the pixle (R, G, B) and calls Plot_Px 
to plot the circle in 8 part symmetry
*/
